...
This section shows how to open a Genetics10 notebook in the Google Colab environment. If you already have opened Genetics10 in Jupyter Lab, you can skip this section and jump to [the next section](#codes-functions-and-how-to-use-them).

Google Colab is a free platform that allows you to run Jupyter Notebooks in the cloud. First, open colab in the web [colab.research.google.com](https://colab.research.google.com).

![Image of new Colab tab](https://github.com/joanalnu/genetics10/raw/main/pictures/newColab.png)

Next, you'll need to go to the GitHub tab and search for 'joanalnu' in the search tab.

![Image of GitHub tab](https://github.com/joanalnu/genetics10/raw/main/pictures/goingToTab.png)

Then select the ```joanalnu/genetics10``` and open the notebook in your preferred language.

![Video of opening a notebook](https://github.com/joanalnu/genetisc10/raw/main/pictures/openNotebook.gif)

Great! Now you can continue to the [next section](#codes-functions-and-how-to-use-them), which explains how to use the notebook you've just opened.
...
### Contact me!
If you have further doubts, feel free to contact me at [joanalnu@outlook.com](mailto:joanalnu@outlook.com). I'm also open to schedule meetings or calls.
